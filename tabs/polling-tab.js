        ...
        <div class="polling-grid">
          <div class="analysis-panel">
            <div class="analysis-card polling-chart-card">
              ...
              <div class="ac-dek">The same historical polling chart used in governance mode, now available during the campaign.</div>
          ...
          <div class="events-panel">
            <div class="analysis-card">
              ...
              <div class="ac-dek" id="polling-tab-side-dek">Average of weekly polling.</div>
